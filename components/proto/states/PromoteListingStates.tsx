    ...
    <View>
      <StateSection title="default">
        <View className="py-4">
          ...
          <PackageCard name="TOP" price="15 GEL" description="Поднятие в топ на 3 дня" icon="arrow-up-circle" color="#0A7B8A" />
          <PackageCard name="VIP" price="25 GEL" description="VIP-метка + топ на 7 дней" icon="star" color="#f59e0b" />
          <PackageCard name="Выделение" price="10 GEL" description="Цветная рамка на 5 дней" icon="color-palette" color="#2E7D30" />
        </View>
      </StateSection>
