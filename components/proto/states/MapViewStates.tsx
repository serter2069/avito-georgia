    ...
    <View>
      <StateSection title="coming_soon">
        <View className="py-16 items-center">
          <Ionicons name="map-outline" size={64} color="#6A8898" />
          <Text className="text-text-primary text-xl font-bold mt-4">Map view coming soon</Text>
          ...
          <TouchableOpacity className="border border-primary px-4 py-2 rounded-lg mt-6">
