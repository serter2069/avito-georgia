...
export const pageRegistry: PageEntry[] = [
  ...
  },
  {
    ...
    qaCycles: 5,
    qaScore: 95,
    notes: [{ date: '2026-04-10', text: 'Управление категориями объявлений. Дерево категорий (родитель→дети). Добавить / переименовать / скрыть категорию. i18n: KA/RU/EN' }],
  },
  {
    id: 'admin-reports',
    title: 'Admin Reports',
    ...
    qaCycles: 5,
    qaScore: 95,
    notes: [{ date: '2026-04-10', text: 'Жалобы пользователей на объявления. Статусы: новая, рассмотрена. Действия: удалить объявление (с подтверждением), отклонить жалобу' }],
  },
  {
    id: 'admin-payments',
    ...
    qaCycles: 5,
    qaScore: 95,
    notes: [{ date: '2026-04-10', text: 'История всех платежей через Stripe. Фильтр по статусу (все/успешно/ошибка/ожидание). Экспорт CSV.' }],
  },
  {
    id: 'admin-settings',
    ...
    qaCycles: 5,
    qaScore: 97,
    notes: [{ date: '2026-04-10', text: 'Глобальные настройки платформы: комиссии, лимиты объявлений, email-шаблоны, режим обслуживания (Switch + предупреждение)' }],
  },
